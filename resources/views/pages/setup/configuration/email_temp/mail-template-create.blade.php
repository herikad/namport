...
@section('content')
    <section>
        <h5 class="py-3 breadcrumb-wrapper mb-2">
            <span class="text-muted fw-light"><a href="/"><i class="bx bx-home-alt"></i></a> / {{ trans('pages.attribute_list.setup') }} / {{ trans('pages.attribute_list.configuration') }} / </span><a href="{{route('setup.config.email_temp.index')}}">{{ trans('pages.mail_template_list.mail') }}</a> / {{ trans('pages.add_with_attr', ['attribute' => 'Email Template']) }}
        </h5>
        <div class="card">

            <div class="card-header pt-75">
                <h4 class="card-title">{{ trans('pages.add_with_attr', ['attribute' => 'Mail Template']) }}
                </h4>
            </div>
                    ...
                    <div class="form-body">
                                ...
                                <div class="row mr-25">
                                    ...
                                    <div class="col-md-6 mb-3  col-sm-12 form-group">
                                        <div class="controls">
                                            ...
                                            <input type="text" name="mail_type" class="form-control" required>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-6 mb-3 col-sm-12">
                                        ...
                                        <select class="custom-select form-control email_setting_id_select" name="email_setting_id">
                                            ...
                                            @foreach ($mails as $mail)
                                                ...
                                                <option value="{{ $mail->email_setting_id }}">{{ $mail->email_id }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group col-12 col-sm-12 mb-3">
                                        ...
                                        <textarea id="mail-body-textarea" class="ckeditor form-control" data-element-ref="ckeditor" name="body"></textarea>
                        ...
                        <div class="col-md-12 text-end">
                            <input type="submit" class="btn btn-success"
                                id="saveMailTempSettingBtn" value="{{ trans('pages.save') }}">
